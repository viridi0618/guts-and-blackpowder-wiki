    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative overflow-hidden border-b border-[#2a2826]">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-24 text-center">
          ...
          <p className="mt-6 text-lg md:text-xl text-[#8a8884] max-w-2xl mx-auto leading-relaxed">
            How to survive your first match in Guts and Blackpowder 鈥?basic controls, combat tips, and class recommendations
          </p>
      ...
      <div className="mx-auto max-w-4xl px-4 py-16 space-y-20">
        ...
        <section>
          ...
          <div className="mt-8 space-y-4">
            {[
              ...
              { title: "Choose Your Class", desc: "Start with Line Infantry 鈥?it's the most beginner-friendly class. You get a musket with a bayonet, making you effective at both ranged and melee combat. As you learn the game, experiment with other classes." },
              ...
              { title: "Watch the Objective", desc: "In Objective mode, follow the on-screen prompts. Each map has unique objectives 鈥?find keys, light signal fires, capture positions, and escape. The minimap shows your next objective location." },
            ].map((item, i) => (
        ...
        <section>
          ...
          <div className="mt-8 space-y-4">
            {[
              { title: "Use Melee for Shamblers", desc: "Shamblers are the slow, basic zombies. Don't waste musket shots on them 鈥?use your bayonet or sabre instead. Save your ammo for special enemies." },
              ...
              { title: "Watch Your Infection", desc: "Getting hit by zombies causes infection, shown by a green bar on your HUD. When it fills up, you turn into a zombie. Only the Surgeon can cure infection 鈥?find one fast if you're infected." },
            ].map((item, i) => (
              <div key={i} className="rounded-lg p-5" style={{ backgroundColor: "rgba(255,255,255,0.03)", border: "1px solid #2a2826", borderLeft: "3px solid #d4af6a" }}>
                <h3 className="font-serif text-base text-[#d4af6a] mb-2">{i + 1}. {item.title}</h3>
                <p className="text-sm text-[#8a8884]">{item.desc}</p>
        ...
        <section>
          ...
          <div className="mt-8 rounded-lg p-6" style={{ backgroundColor: "rgba(255,255,255,0.03)", border: "1px solid #2a2826", borderLeft: "3px solid #d4af6a" }}>
            <p className="text-base text-[#c8c4bc] mb-4">
              <strong className="text-[#d4af6a]">Start with Line Infantry.</strong> It&apos;s the most versatile class 鈥?the musket with bayonet lets you handle any situation. You&apos;ll learn the fundamentals of both ranged and melee combat without being overwhelmed by special abilities.
            </p>
            ...
            <div className="space-y-2">
              {[
                ...
                <div key={i} className="flex items-start gap-3 p-3 rounded-lg" style={{ backgroundColor: "rgba(255,255,255,0.03)", border: "1px solid #2a2826" }}>
                  ...
                  <span className="text-xs text-[#8a8884]">{item.why} 鈥?<span className="text-[#d4af6a]">{item.when}</span></span>
                </div>
              ))}
            </div>
          </div>
        ...
        <section>
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-2">
            {[
              { mode: "Objective", desc: "The main mode. Complete map objectives then escape. Deaths respawn at checkpoints. Start here 鈥?it's the most forgiving mode.", players: "Up to 12", maps: "9" },
        ...
        <section>
          ...
          <div className="mt-8 space-y-3">
            {[
              ...
              "The Chaplain class is locked behind the Soldier&apos;s Grace badge 鈥?play Surgeon without dying in an Objective map to unlock it",
