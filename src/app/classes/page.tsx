        ...
        <section>
          <div className="rounded-lg p-6" style={{ backgroundColor: "rgba(255,255,255,0.03)", border: "1px solid #2a2826" }}>
            ...
            <ul className="space-y-2">
              <li><a href="/weapons" className="text-sm text-[#d4af6a] hover:underline">Weapons Guide — Best Weapon for Each Class</a></li>
              <li><a href="/enemies" className="text-sm text-[#d4af6a] hover:underline">Enemies Guide — Which Class to Pick Based on Enemy Types</a></li>
              <li><a href="/badges" className="text-sm text-[#d4af6a] hover:underline">Badges — How to Unlock Chaplain Class</a></li>
              <li><a href="/beginner-guide" className="text-sm text-[#d4af6a] hover:underline">Beginner Guide — Recommended Starting Class</a></li>
              <li><a href="/commands" className="text-sm text-[#d4af6a] hover:underline">Commands — Change Class with /class Command</a></li>
            </ul>
          </div>
        </section>
      </div>
