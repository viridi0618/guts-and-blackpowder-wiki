        ...
        <section>
          <div className="rounded-lg p-6" style={{ backgroundColor: "rgba(255,255,255,0.03)", border: "1px solid #2a2826" }}>
            ...
            <ul className="space-y-2">
              <li><a href="/badges" className="text-sm text-[#d4af6a] hover:underline">All Badges & How to Unlock Them</a></li>
              <li><a href="/enemies" className="text-sm text-[#d4af6a] hover:underline">All Enemy Types Guide</a></li>
              <li><a href="/guides/francs" className="text-sm text-[#d4af6a] hover:underline">How to Get Francs Fast</a></li>
              <li><a href="/wiki" className="text-sm text-[#d4af6a] hover:underline">Guts and Blackpowder Wiki — Full Overview</a></li>
            </ul>
          </div>
        </section>
      </div>
